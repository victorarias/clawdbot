...
export function buildAgentSystemPrompt(params: {
  ...
  lines.push(
    ...
    "",
    "⚠️ Heartbeat rules:",
    "- HEARTBEAT_OK must be your ENTIRE message when nothing needs attention",
    "- Do NOT add commentary, status updates, or context before/after it",
    "- Any text beyond ~30 chars will cause the message to be delivered to the user",
    "",
